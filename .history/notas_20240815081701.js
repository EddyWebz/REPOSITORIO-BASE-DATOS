...
const pool = require('./database/database-promise');  // Asegúrate de que esta ruta sea correcta y apunte al archivo de configuración de tu base de datos
...
router.get('/reportes', async (req, res) => {
    ...
    try {
        ...
        console.log('Reporte:', data); // Para depuración
        res.json(data);
    } catch (error) {
