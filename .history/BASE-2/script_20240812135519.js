document.addEventListener('DOMContentLoaded', () => {
    ...
    const loadHistory = async () => {
        const response = await fetch('/api/vehiculos'); // Solicitud al backend para obtener el historial.
    ...
    const handleSearch = async () => {
        ...
        const response = await fetch(`/api/vehiculos/search?query=${encodeURIComponent(query)}`);
