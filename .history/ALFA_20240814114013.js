...
router.get('/history', (req, res) => {
    ...
    connection.query('SELECT * FROM vehiculos WHERE user_id = ? ORDER BY id ASC', [user_id], (err, results) => {
        if (err) {
...
router.get('/search', (req, res) => {
    ...
    const sql = 'SELECT * FROM vehiculos WHERE (owner LIKE ? OR plate LIKE ?) AND user_id = ? ORDER BY id ASC';
