...
const vehiculosRoutes = require('./vehiculos.js');  // Asegúrate de que la ruta al archivo vehiculos.js sea correcta
app.use('/api/vehiculos', vehiculosRoutes);  // Configura la ruta base para vehiculos.js
