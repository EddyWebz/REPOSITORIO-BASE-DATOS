...
function calcularHoraSalida(horaIngreso, numeroNoches) {
    ...
    if (fechaHoraIngreso.getHours() >= 15 || fechaHoraIngreso.getHours() < 4) {
        ...
        if (fechaHoraIngreso.getHours() < 4) {
            // Si es antes de las 4:00 AM, pertenece a la noche del día anterior
        ...
        horaSalidaEstimada = new Date(fechaHoraIngreso.setHours(17, 38, 0, 0));
